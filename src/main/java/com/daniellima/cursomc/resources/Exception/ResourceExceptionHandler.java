...
public class ResourceExceptionHandler {
	...
	// Metodo de exception para caso de um delete em uma categoria que contenha
	// algum produto.
	...
	public ResponseEntity<StandardError> ataIntegrity(MethodArgumentNotValidException e, HttpServletRequest request) {
